...
public final class ConfigFileService {
    ...
    private FileConfiguration worldgen;
    ...
    public void reload() {
        ...
        this.worldgen = loadFile("worldgen.yml");
        reloadLevelFiles();
        ...
        warnIgnoredLegacySection("worldgen", "worldgen.yml");
    ...
    public FileConfiguration worldgen() {
        return worldgen;
    }
